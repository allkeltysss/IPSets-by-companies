...
- **cloudflare.txt** содержит ipv4 и ipv6 диапозоны с официальной страницы компании: https://www.cloudflare.com/ips/ **(Помогает с обходом блокировки сервисов Cloudflare, в том числе и Cloudflare WARP)**

- **ipset-all.txt** объединяет в себя CIDR'ы aws, cloudflare и hetzner.txt **(Добавляйте этот список в в запрет, если хотите одновременной разблокировки Cloudflare WARP, Battlefield 6 и прочих игр/сервисов)**
___
