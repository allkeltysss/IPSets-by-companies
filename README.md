...
- Для **hetzner.txt** я использовал данные из репозитория: https://github.com/Pymmdrza/Datacenter_List_DataBase_IP/blob/mainx/Hetzner/CIDR.txt **(Для разблокировки некоторых впн сервисов и серверов в разных играх, в особенности серверов Майнкрафта)**
